    ...
    try {
      ...
      if (!msg) {
        const greetings = [
          ...
          "এত ডাকিস না বস তন্ময় এর সাথে ভিডিও কলে আছি","আমাকে এতো না ডেকে বস 🌼⎯𝘾𝙪𝙩𝙚♡︎𝙏𝙊𝙉𝙈𝙊𝙔⎯🌼 কে একটা গফ দে 🙄",
          "উফফ জান তুমি এত হট কেন","কিরে লাস্ট কবে গোসল করছিলি","jang hanga korba",
          "jang bal falaba🙂"
        ];
